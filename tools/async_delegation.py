...
def dispatch_async_delegation(
    *,
    ...
    record: Dict[str, Any] = {
        ...
        "origin_cxba_run_id": origin_cxba_run_id,
        "parent_session_id": parent_session_id,
        "status": "running",
...
def _push_completion_event(
    ...
    evt = {
        ...
        "origin_cxba_run_id": record.get("origin_cxba_run_id", ""),
...
def _push_batch_completion_event(
    ...
    evt = {
        ...
        "origin_cxba_run_id": event_record.get("origin_cxba_run_id", ""),
