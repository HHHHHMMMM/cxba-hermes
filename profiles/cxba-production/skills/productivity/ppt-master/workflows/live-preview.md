...
```bash
python3 /root/.hermes/skills/productivity/ppt-master/scripts/svg_editor/server.py <project_path>
```
...
1. Discover annotations:
   ```bash
   python3 /root/.hermes/skills/productivity/ppt-master/scripts/check_annotations.py <project_path>
   ```
...
```bash
python3 /root/.hermes/skills/productivity/ppt-master/scripts/svg_editor/server.py <project_path> --no-browser
# or for Step 6's auto-startup on a remote host:
python3 /root/.hermes/skills/productivity/ppt-master/scripts/svg_editor/server.py <project_path> --live --no-browser
```
