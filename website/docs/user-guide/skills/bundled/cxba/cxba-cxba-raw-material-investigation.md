---
title: "Cxba Raw Material Investigation — Test case hypotheses against sources and counter-evidence"
sidebar_label: "Cxba Raw Material Investigation"
...
Test case hypotheses against sources and counter-evidence.
...
| Path | `skills/cxba/cxba-raw-material-investigation` |
| Version | `0.1.0` |
| Author | CXBA Project Team, Hermes Agent |
| License | MIT |
| Platforms | linux |
| Tags | `cxba`, `evidence`, `verification` |
| Related skills | [`cxba-case-investigation`](/docs/user-guide/skills/bundled/cxba/cxba-cxba-case-investigation), [`cxba-material-profiling`](/docs/user-guide/skills/bundled/cxba/cxba-cxba-material-profiling), [`cxba-safe-tabular-analysis`](/docs/user-guide/skills/bundled/cxba/cxba-cxba-safe-tabular-analysis) |
